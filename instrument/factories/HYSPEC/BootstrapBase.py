...
## This piece of code create a graph of instrument elements for HYSPEC.
## modified from ..SEQUOIA.BootstrapBase
...
class InstrumentFactory( object):
    ...
    Instrument object and a geometer for HYSPEC"""
...
'''
    ...
    def makeDetectorSystem( self, instrument, geometer, packs):
        ...
        return # detArray # hyspec, geometer
